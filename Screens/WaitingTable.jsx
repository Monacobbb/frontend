...
const WaitingTableScreen = ({ navigation, route }) => {
  ...
  // const pendingURL = 'http://192.168.200.142:8080/waitingdeal/userpending/' + postId // 상품 상세 페이지에서 postId 받아오기
  ...
  const fetchPendingUser = async () => {
    try {
      const response = await axios.get(
        'http://192.168.200.142:8080/waitingdeal/userpending/' + postId /* + postId*/
      )
  ...
  const fetchAcceptedUser = async () => {
    try {
      const response = await axios.get(
        'http://192.168.200.142:8080/waitingdeal/useraccepted/' + postId /* + postId*/
      )
